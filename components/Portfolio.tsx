...
import { motion, useAnimation, PanInfo, useMotionValue, useTransform, useAnimationFrame, useScroll } from 'framer-motion';
...
const Portfolio: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="py-32 relative z-10 overflow-hidden min-h-[900px] flex flex-col justify-center" id="work">
      ...
      <div className="max-w-7xl mx-auto px-4 w-full relative z-10">
        ...
        <motion.div style={{ scale, opacity }} className="h-[500px] w-full flex items-center justify-center perspective-container [perspective:1500px] md:scale-100 origin-center">
             <motion.div
